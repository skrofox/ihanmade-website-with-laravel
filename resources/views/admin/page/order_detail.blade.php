    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <div class="text-sm space-y-1">
                    <p><span class="font-medium">Tổng tiền:</span> <span class="text-green-600 font-semibold">{{ $order->formatted_grand_total }}</span></p>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    @if($item->variant && $item->variant->option_value_text !== 'Không có')
                                        <div class="text-sm text-gray-600">{{ $item->variant->option_value_text }}</div>
                                    @endif
                                </div>
                            </div>
                        </td>
