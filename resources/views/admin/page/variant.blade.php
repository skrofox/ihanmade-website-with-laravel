...
@section('header', 'Quản lý biến thể sản phẩm')
    ...
    <div class="max-w-7xl mx-auto py-6">
        <div class="bg-white shadow-md rounded-lg">
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h2 class="text-xl font-semibold text-gray-800">Danh sách biến thể sản phẩm</h2>
                <a href="{{ route('variant_create') }}"
                ...
                <form method="GET" class="flex gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Tìm kiếm theo SKU, mã vạch..."
            ...
            @if($variants->hasPages())
                <div class="px-6 py-4 border-t border-gray-200">
                    {{ $variants->links('pagination.page_custom') }}
                </div>
            @endif
        </div>
    </div>
