...
<header class="bg-gray-900 fixed w-full z-[999]">
    <p
        class="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8 hover:text-sky-300">
        ihandmade@gmail.com - Shop Handmade
    </p>
                    ...
                    <button type="button"
                        ...
                        <svg class="w-6 h-6 mr-2 text-white" fill="none" stroke="currentColor" stroke-width="1.5"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.75 17.25V19.5A2.25 2.25 0 0113.5 21.75h-3A2.25 2.25 0 018.25 19.5v-2.25m7.5-6A4.5 4.5 0 1112 6a4.5 4.5 0 014.5 4.5z" />
                        </svg>
                        {{ Auth::user()->name }}
                        <svg class="w-4 h-4 ml-1 text-white" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
